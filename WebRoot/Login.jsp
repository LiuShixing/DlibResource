...
<%
    ...
    if( wikiSession.isAuthenticated() )
    {
        ...
        //修改
        if(redirectPage.equals("upload"))
        {
           //修改
            log.info( "Redirecting user to upload" );
            response.sendRedirect( "Home.jsp?tag=upload" );
            return;
        }
        ...
        if( !wiki.pageExists( redirectPage ) )
        {
           ...
           //修改
            log.info( "Redirecting user to all resource list" );
