...
<%
    ...
    String pagereqKey = wikiContext.getName();
    
    HttpSession sess = request.getSession();
    sess.setAttribute(MyUtil.REQ_RES_ID, pagereqKey.toLowerCase());
    ...
    */
    ...
    String red_page = "Home.jsp?tag=all";
    if(!wikiSession.isAuthenticated())
    {
     	red_page = "Home.jsp?tag=article";
    }
   
      String p = request.getParameter("page");
      if( !(p!=null && p.equals("help")))
      {
	     if(p==null || !wiki.pageExists( p ) )
	      {
	         String t = request.getParameter("tag");
	         if(t==null || !t.equals("new"))
	         {   	 
...
%><wiki:Include page="<%=contentPage%>" /><%
    ...
    {
        sw.stop();
       /*  if( log.isDebugEnabled() ) log.debug("Total response time from server on page "+resourceTitle+": "+sw); */
        w.exitState();
    }
%>
