    ...
    --%>
     ...
     <div class="form-group">
       ...
       <wiki:UserProfile property="canChangeLoginName">
           <input class="form-control form-col-50" type="text" name="loginname" id="loginname" readonly="true"
     ...
     <div class="form-group">
       ...
       <span class="dropdown form-col-50">
         <input class="form-control" type="text" name="fullname" id="fullname" size="20" readonly="true"
