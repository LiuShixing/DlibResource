  ...
  <ul class="dropdown-menu pull-right" data-hover-parent=".userbox">
    ...
    <li class="dropdown-header">
      ...
      String user = wikiSession.getUserPrincipal().getName();
       ...
       %>
          <wiki:Link cssClass="btn btn-primary btn-block login icon-signin" jsp="CheckHomepageExist.jsp">
            <wiki:Param name='fullName' value='<%=user %>'/>
          	个人中心
        </wiki:Link>
     ...
     data-modal=".modal">
          ...
          <div class="modal text-align-center" >您确定要退出吗？</div>
        </a>
      </wiki:UserCheck>
    </li>
  </ul>
